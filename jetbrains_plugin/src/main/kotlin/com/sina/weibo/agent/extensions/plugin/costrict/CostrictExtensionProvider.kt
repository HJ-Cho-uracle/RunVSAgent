...
/**
 * Costrict 확장 제공자 구현체입니다.
 * `ExtensionProvider` 인터페이스를 구현하여 Costrict 확장에 대한 메타데이터와 생명주기 메소드를 제공합니다.
 */
class CostrictExtensionProvider : ExtensionProvider {
    ...
    override fun initialize(project: Project) {
        ...
        try {
            ...
            // ExtensionManagerFactory를 사용할 수 없어도 Costrict 확장은 독립적으로 작동할 수 있습니다.
        }
    }
    ...
    /**
     * Costrict 확장 리소스를 해제합니다. (필요한 경우 구현)
     */
